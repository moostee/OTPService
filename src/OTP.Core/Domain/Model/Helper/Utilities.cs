...
namespace OTP.Core.Domain.Model.Helper
{
    public class Utilities
    {
        ...
        public static ResponseModel CatchException(ResponseModel response, string errorMessage = null)
        {
            ...
            response.ResponseMessage = string.IsNullOrEmpty(errorMessage) ? "Error occurred while processing your request" : errorMessage;
            return response;
        }
        ...
        public static async Task<IRestResponse> MakeApiRequest(RestSharp.Method method, string url, string parameter = null, string clientSecret = null)
        {
